...
import me.vexinglemons.hexicon.util.Tags;
...
public class Firestone extends Item {
    ...
    public void addInformation(ItemStack stack, @Nullable World worldIn, List<ITextComponent> tooltip, ITooltipFlag flagIn) {
        ...
        {
            tooltip.add(new TranslationTextComponent("tooltip.hexicon.firestone_shift"));
        } else
        {
            tooltip.add(new TranslationTextComponent("tooltip.hexicon.firestone"));
        }
