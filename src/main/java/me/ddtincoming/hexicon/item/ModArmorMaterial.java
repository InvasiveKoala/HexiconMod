...
public enum ModArmorMaterial implements IArmorMaterial {
    AMETHYST("amethyst", 7, new int[] {3, 6, 8, 3}, 12,
            SoundEvents.ITEM_ARMOR_EQUIP_IRON, 1.0f, 0.0f, () -> {return Ingredient.fromItems(ModItems.AMETHYST.get());
    });
    ...
    public String getName() {
        return Hexicon.MOD_ID + ":" + this.name;
    }
