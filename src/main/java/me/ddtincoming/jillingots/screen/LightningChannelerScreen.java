package me.ddtincoming.jillingots.screen;
...
public class LightningChannelerScreen extends ContainerScreen<LightningChannelerContainer> {
    private final ResourceLocation GUI = new ResourceLocation(JillIngots.MOD_ID, "textures/gui/lightning_channeler_gui.png");
