...
import static me.ddtincoming.jillingots.item.custom.spells.GlobalWordFunctions.getUsedAdverbs;
import static me.ddtincoming.jillingots.item.custom.spells.Mobnames.translate;
import static me.ddtincoming.jillingots.item.custom.spells.WordFunctions.*;
import static me.ddtincoming.jillingots.util.Methods.findIndex;
    ...
    public static Entity chooseTarget(PlayerEntity caster, String word, boolean[] specifiers, int verb)
    {
        ...
        if (specifiers[0])
        {
            ...
            for(Entity entity : entities)
            {
                ...
                {
                    if (entity.getDistance(caster) < target.getDistance(caster))
                    {
                        target = entity;
                    }
                }
