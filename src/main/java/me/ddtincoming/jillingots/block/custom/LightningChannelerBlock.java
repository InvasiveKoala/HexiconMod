package me.ddtincoming.jillingots.block.custom;

import me.ddtincoming.jillingots.container.LightningChannelerContainer;
import me.ddtincoming.jillingots.tileentity.LightningChannelerTile;
    ...
    private INamedContainerProvider createContainerProvider(World worldIn, BlockPos pos) {
        return new INamedContainerProvider() {
            ...
            public ITextComponent getDisplayName() {
                return new TranslationTextComponent("screen.jillingots.lightning_channeler");
            }
